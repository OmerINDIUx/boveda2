...
], RfiHistory.prototype, "id", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'rfi_id' }),
    __metadata("design:type", String)
], RfiHistory.prototype, "rfiId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => rfi_entity_1.Rfi, (rfi) => rfi.history),
    (0, typeorm_1.JoinColumn)({ name: 'rfi_id' }),
    __metadata("design:type", rfi_entity_1.Rfi)
], RfiHistory.prototype, "rfi", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'actor_id', nullable: true }),
    __metadata("design:type", String)
], RfiHistory.prototype, "actorId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'actor_id' }),
    __metadata("design:type", user_entity_1.User)
], RfiHistory.prototype, "actor", void 0);
__decorate([
    (0, typeorm_1.Column)({ length: 80 }),
    __metadata("design:type", String)
], RfiHistory.prototype, "action", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'before_state', type: 'json', nullable: true }),
    __metadata("design:type", Object)
], RfiHistory.prototype, "beforeState", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'after_state', type: 'json', nullable: true }),
    __metadata("design:type", Object)
], RfiHistory.prototype, "afterState", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: 'created_at' }),
    __metadata("design:type", Date)
], RfiHistory.prototype, "createdAt", void 0);
exports.RfiHistory = RfiHistory = __decorate([
    (0, typeorm_1.Entity)('rfi_history')
], RfiHistory);
