...
__decorate(
  [(0, typeorm_1.Column)({ name: 'comment', type: 'text' }), __metadata('design:type', String)],
  RfiComment.prototype,
  'body',
  void 0
);
...
exports.RfiComment = RfiComment = __decorate([(0, typeorm_1.Entity)('rfi_comments')], RfiComment);
