...
let RfisService = class RfisService {
    ...
    storage;
    notifications;
    constructor(rfis, comments, attachments, history, projects, members, documents, scope, storage, notifications) {
        this.rfis = rfis;
...
exports.RfisService = RfisService = __decorate([
    ...
    __param(5, (0, typeorm_1.InjectRepository)(project_member_entity_1.ProjectMember)),
    __param(6, (0, typeorm_1.InjectRepository)(document_entity_1.DocumentRecord)),
