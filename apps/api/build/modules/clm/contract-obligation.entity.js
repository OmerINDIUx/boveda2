...
], ContractObligation.prototype, "id", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'contract_id' }),
    __metadata("design:type", String)
], ContractObligation.prototype, "contractId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => contract_entity_1.Contract, (contract) => contract.obligations),
    (0, typeorm_1.JoinColumn)({ name: 'contract_id' }),
    __metadata("design:type", contract_entity_1.Contract)
], ContractObligation.prototype, "contract", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'text' }),
    __metadata("design:type", String)
], ContractObligation.prototype, "description", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'responsible_user_id', nullable: true }),
    __metadata("design:type", String)
], ContractObligation.prototype, "responsibleUserId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'responsible_user_id' }),
    __metadata("design:type", user_entity_1.User)
], ContractObligation.prototype, "responsibleUser", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'commitment_date', type: 'date', nullable: true }),
    __metadata("design:type", String)
], ContractObligation.prototype, "commitmentDate", void 0);
__decorate([
    (0, typeorm_1.Column)({ default: 'pending' }),
    __metadata("design:type", String)
], ContractObligation.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'evidence_document_id', nullable: true }),
    __metadata("design:type", String)
], ContractObligation.prototype, "evidenceDocumentId", void 0);
__decorate([
...
], ContractObligation.prototype, "evidenceDocument", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'text', nullable: true }),
    __metadata("design:type", String)
], ContractObligation.prototype, "comments", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: 'created_at' }),
    __metadata("design:type", Date)
], ContractObligation.prototype, "createdAt", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)({ name: 'updated_at' }),
    __metadata("design:type", Date)
], ContractObligation.prototype, "updatedAt", void 0);
__decorate([
    (0, typeorm_1.DeleteDateColumn)({ name: 'deleted_at' }),
    __metadata("design:type", Date)
], ContractObligation.prototype, "deletedAt", void 0);
