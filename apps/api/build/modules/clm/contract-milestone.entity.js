...
], ContractMilestone.prototype, "id", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'contract_id' }),
    __metadata("design:type", String)
], ContractMilestone.prototype, "contractId", void 0);
__decorate([
...
], ContractMilestone.prototype, "contract", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'name', length: 180 }),
    __metadata("design:type", String)
], ContractMilestone.prototype, "name", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'milestone_date', type: 'date' }),
    __metadata("design:type", String)
], ContractMilestone.prototype, "milestoneDate", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'responsible_user_id', nullable: true }),
    __metadata("design:type", String)
], ContractMilestone.prototype, "responsibleUserId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'responsible_user_id' }),
    __metadata("design:type", user_entity_1.User)
], ContractMilestone.prototype, "responsibleUser", void 0);
__decorate([
    (0, typeorm_1.Column)({ default: 'pending' }),
    __metadata("design:type", String)
], ContractMilestone.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'completed_at', type: 'datetime', nullable: true }),
    __metadata("design:type", Date)
], ContractMilestone.prototype, "completedAt", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'evidence_document_id', nullable: true }),
    __metadata("design:type", String)
], ContractMilestone.prototype, "evidenceDocumentId", void 0);
__decorate([
...
], ContractMilestone.prototype, "evidenceDocument", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'text', nullable: true }),
    __metadata("design:type", String)
], ContractMilestone.prototype, "notes", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: 'created_at' }),
    __metadata("design:type", Date)
], ContractMilestone.prototype, "createdAt", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)({ name: 'updated_at' }),
    __metadata("design:type", Date)
], ContractMilestone.prototype, "updatedAt", void 0);
__decorate([
    (0, typeorm_1.DeleteDateColumn)({ name: 'deleted_at' }),
    __metadata("design:type", Date)
], ContractMilestone.prototype, "deletedAt", void 0);
