...
__decorate([
    (0, typeorm_1.ManyToOne)(() => contract_entity_1.Contract, (contract) => contract.versions),
...
__decorate([
    (0, typeorm_1.Column)({ name: 'version_label', length: 40 }),
    __metadata("design:type", String)
], ContractVersion.prototype, "versionLabel", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'file_key' }),
    __metadata("design:type", String)
], ContractVersion.prototype, "fileKey", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'file_name' }),
    __metadata("design:type", String)
], ContractVersion.prototype, "fileName", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'file_extension', length: 30, nullable: true }),
    __metadata("design:type", String)
], ContractVersion.prototype, "fileExtension", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'mime_type', length: 120 }),
    __metadata("design:type", String)
], ContractVersion.prototype, "mimeType", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'size_bytes', type: 'bigint' }),
    __metadata("design:type", Number)
], ContractVersion.prototype, "sizeBytes", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'uploaded_by_id' }),
    __metadata("design:type", String)
], ContractVersion.prototype, "uploadedById", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User),
    (0, typeorm_1.JoinColumn)({ name: 'uploaded_by_id' }),
    __metadata("design:type", user_entity_1.User)
], ContractVersion.prototype, "uploadedBy", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'change_summary', type: 'text', nullable: true }),
    __metadata("design:type", String)
], ContractVersion.prototype, "changeSummary", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Date)
], ContractVersion.prototype, "deletedAt", void 0);
