...
], DocumentQueryHistory.prototype, "id", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'user_id' }),
    __metadata("design:type", String)
], DocumentQueryHistory.prototype, "userId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User),
    (0, typeorm_1.JoinColumn)({ name: 'user_id' }),
    __metadata("design:type", user_entity_1.User)
], DocumentQueryHistory.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'project_id', nullable: true }),
    __metadata("design:type", String)
], DocumentQueryHistory.prototype, "projectId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => project_entity_1.Project, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'project_id' }),
    __metadata("design:type", project_entity_1.Project)
], DocumentQueryHistory.prototype, "project", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'document_id', nullable: true }),
    __metadata("design:type", String)
], DocumentQueryHistory.prototype, "documentId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'text' }),
    __metadata("design:type", String)
], DocumentQueryHistory.prototype, "question", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'longtext' }),
    __metadata("design:type", String)
], DocumentQueryHistory.prototype, "answer", void 0);
__decorate([
    (0, typeorm_1.Column)({ length: 40 }),
    __metadata("design:type", String)
], DocumentQueryHistory.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'citations_json', type: 'json', nullable: true }),
    __metadata("design:type", Array)
], DocumentQueryHistory.prototype, "citationsJson", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'response_json', type: 'json', nullable: true }),
    __metadata("design:type", Object)
], DocumentQueryHistory.prototype, "responseJson", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: 'created_at' }),
    __metadata("design:type", Date)
], DocumentQueryHistory.prototype, "createdAt", void 0);
