...
export declare class NotificationsService {
    ...
    constructor(notifications: Repository<Notification>, preferences: Repository<NotificationPreference>, deliveries: Repository<NotificationDelivery>, users: Repository<User>, documents: Repository<DocumentRecord>, approvalRequests: Repository<ApprovalRequest>, approvalSteps: Repository<ApprovalStep>, contracts: Repository<Contract>, obligations: Repository<ContractObligation>, rfis: Repository<Rfi>, mailer: SmtpMailService, config: ConfigService);
    ...
    listPreferences(userId: string): Promise<{
        notificationType: "document_expiring_soon" | "document_expired" | "approval_assigned" | "approval_stopped" | "rfi_assigned" | "rfi_overdue" | "contract_expiring_soon" | "contract_expired" | "contract_obligation_pending" | "document_new_version" | "document_approval_result";
        label: string;
        inAppEnabled: boolean;
        emailEnabled: boolean;
    }[]>;
    updatePreferences(userId: string, items: Array<{
        notificationType: string;
        inAppEnabled: boolean;
        emailEnabled: boolean;
    }>): Promise<{
    ...
    create(userId: string, title: string, body: string, meta?: {
        type?: string;
        entityType?: string;
        entityId?: string;
        notificationType?: NotificationType;
