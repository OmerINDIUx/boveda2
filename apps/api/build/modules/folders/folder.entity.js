...
__decorate(
  [(0, typeorm_1.Column)({ name: 'parent_id', nullable: true }), __metadata('design:type', String)],
  Folder.prototype,
  'parentId',
  void 0
);
...
__decorate(
  [(0, typeorm_1.Column)({ length: 600, nullable: true }), __metadata('design:type', String)],
  Folder.prototype,
  'path',
  void 0
);
...
exports.Folder = Folder = __decorate([(0, typeorm_1.Entity)('folders')], Folder);
