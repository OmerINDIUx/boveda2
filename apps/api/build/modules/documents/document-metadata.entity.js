...
__decorate([
    (0, typeorm_1.ManyToOne)(() => document_entity_1.DocumentRecord, (document) => document.metadata),
    (0, typeorm_1.JoinColumn)({ name: 'document_id' }),
    __metadata("design:type", document_entity_1.DocumentRecord)
], DocumentMetadata.prototype, "document", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'meta_key', length: 120 }),
    __metadata("design:type", String)
], DocumentMetadata.prototype, "metaKey", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'meta_value', type: 'text', nullable: true }),
    __metadata("design:type", String)
], DocumentMetadata.prototype, "metaValue", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'value_type', default: 'string' }),
    __metadata("design:type", String)
], DocumentMetadata.prototype, "valueType", void 0);
__decorate([
