...
export const PermissionCatalog: Array<{ key: PermissionKey; label: string; module: string }> = [
  ...
  { key: PermissionKey.ProjectsView, label: 'Ver centro de costos', module: 'projects' },
  { key: PermissionKey.ProjectsManage, label: 'Administrar centros de costos', module: 'projects' },
